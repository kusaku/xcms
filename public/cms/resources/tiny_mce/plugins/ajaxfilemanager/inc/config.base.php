...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,bmp,tif,zip,rar,gz,tar,mov,mpg,avi,mpeg,wmv,wav,mp3,swf,ppt,rtf,doc,pdf,xls,txt,xml,xsl');//
	...
	define('CONFIG_WEBSITE_DOCUMENT_ROOT', realpath( dirname(__FILE__) . '/../../../../../../' ) );	
