...
CREATE TABLE `elements` (
  ...
  KEY `fk_element_menu` (`id_menu`)) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `field_groups` (
  ...
  KEY `fk_field_groups_object_types` (`id_obj_type`)) ENGINE=InnoDB AUTO_INCREMENT=244 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `fields` (
  ...
  KEY `fk_fields_field_types` (`id_type`)) ENGINE=InnoDB AUTO_INCREMENT=193 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `fields_controller` (
  ...
  KEY `ord` (`ord`)) ENGINE=InnoDB DEFAULT CHARSET=cp1251;
...
CREATE TABLE `object_types` (
  ...
  KEY `fk_object_type_parent` (`id_parent`)) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `objects` (
  ...
  KEY `name` (`title`),
  KEY `is_locked` (`is_locked`)) ENGINE=InnoDB AUTO_INCREMENT=10208 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `permissions_elements` (
  ...
  KEY `fk_permissions_elements_usergroup` (`id_owner`)) ENGINE=InnoDB DEFAULT CHARSET=cp1251;
...
CREATE TABLE `permissions_modules` (
  ...
  KEY `fk_permissions_modules_usergroup` (`id_owner`)) ENGINE=InnoDB DEFAULT CHARSET=cp1251;
...
CREATE TABLE `templates` (
  ...
  KEY `filename` (`filename`),
  KEY `title` (`title`),
  KEY `fk_templates_languages` (`id_lang`)) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `users` (
  ...
  KEY `fk_users_usergroup` (`id_usergroup`)) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=cp1251;
...
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10201,187,NULL,NULL,'dlzspb@gmail.com',NULL,NULL,NULL);
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10202,185,NULL,NULL,NULL,'a:1:{i:0;s:5:"10204";}',NULL,NULL);
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10202,188,NULL,NULL,1,NULL,NULL,NULL);
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10203,187,NULL,NULL,'dlz@fabricasaitov.ru',NULL,NULL,NULL);
...
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10205,102,NULL,NULL,NULL,'<p>это текст на странице формы</p>',NULL,NULL);
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10205,182,0,NULL,NULL,NULL,NULL,NULL);
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10205,185,NULL,NULL,NULL,'a:1:{i:0;s:5:"10201";}',NULL,NULL);
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10205,188,NULL,NULL,'fdgdsf',NULL,NULL,NULL);
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10205,189,NULL,NULL,'qwe@qwe.ru',NULL,NULL,NULL);
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10206,187,NULL,NULL,'redlinesoft@yandex.ru',NULL,NULL,NULL);
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10207,185,NULL,NULL,NULL,'a:1:{i:0;s:5:"10204";}',NULL,NULL);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(1,NULL,17,10000,1,0,1000,1,0,1,'Главная','2011-06-14 13:26:43',2);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(5,NULL,28,10004,1,0,1000,1,1,0,'Контакты','2011-06-10 16:38:22',1);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(28,NULL,44,10033,1,NULL,1000,1,0,0,'Новости','2010-12-02 11:00:01',2);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(29,NULL,17,10034,1,NULL,NULL,1,0,0,1290067882,'2011-06-14 13:27:27',1);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(32,28,45,10038,1,NULL,NULL,1,0,0,1290093277,'2010-11-18 18:14:51',1);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(35,NULL,50,10049,1,NULL,1000,1,0,0,'Profile','2010-12-29 11:27:20',3);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(49,NULL,28,10202,1,NULL,1000,0,0,0,1307710906,'2011-06-10 18:38:33',4);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(50,NULL,28,10205,1,NULL,1000,1,0,0,1307716540,'2011-06-14 12:36:33',5);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(51,NULL,28,10207,1,NULL,1000,1,0,0,1308043444,'2011-06-14 13:26:18',6);
...
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(146,'feedback',11,1,0,1,'Настройки формы обратной связи',5);
...
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(230,'common',63,1,0,1,'Редактирование содержимого страницы',1);
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(231,'seo',63,1,0,0,'Настройки для поисковых систем',2);
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(232,'menu',63,1,0,0,'Настройки меню',3);
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(233,'page',63,1,0,0,'Настройки страницы',4);
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(234,'feedback',63,1,0,1,'Настройки формы обратной связи',5);
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(235,'permissions',63,1,0,0,'Права доступа',6);
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(236,'021d3f8c77fcc6d6da4a5187c19cb4bd',63,1,0,1,'FieldGroup021d3f8c77fcc6d6da4a5187c19cb4bd',0);
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(237,'common',64,1,0,1,'Редактирование содержимого страницы',1);
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(238,'seo',64,1,0,0,'Настройки для поисковых систем',2);
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(239,'menu',64,1,0,0,'Настройки меню',3);
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(240,'page',64,1,0,0,'Настройки страницы',4);
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(241,'feedback',64,1,0,1,'Настройки формы обратной связи',5);
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(242,'permissions',64,1,0,0,'Права доступа',6);
INSERT INTO field_groups(id,name,id_obj_type,is_active,is_locked,is_visible,title,ord)	VALUES(243,'30e31fa24974dba0284b4e37d1bd8cca',64,1,0,1,'FieldGroup30e31fa24974dba0284b4e37d1bd8cca',0);
...
INSERT INTO fields(id,name,id_type,id_guide,is_locked,is_inheritable,is_public,is_required,title,tip)	VALUES(188,'fb_f1_1',4,NULL,0,0,1,1,'Ваше имя',NULL);
INSERT INTO fields(id,name,id_type,id_guide,is_locked,is_inheritable,is_public,is_required,title,tip)	VALUES(189,'fb_1_2',13,NULL,0,0,1,1,'E-mail',NULL);
INSERT INTO fields(id,name,id_type,id_guide,is_locked,is_inheritable,is_public,is_required,title,tip)	VALUES(190,'fb_2_1',4,NULL,0,0,1,1,'ФИО',NULL);
INSERT INTO fields(id,name,id_type,id_guide,is_locked,is_inheritable,is_public,is_required,title,tip)	VALUES(191,'fb_2_2',13,NULL,0,0,1,1,'E-mail',NULL);
INSERT INTO fields(id,name,id_type,id_guide,is_locked,is_inheritable,is_public,is_required,title,tip)	VALUES(192,'fb_2_3',5,NULL,0,0,1,1,'Текст сообщения',NULL);
...
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(181,146,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(182,146,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(185,146,1);
...
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(1,230,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(104,231,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(109,232,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(115,233,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(181,234,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(128,235,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(188,236,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(189,236,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(1,237,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(104,238,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(109,239,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(115,240,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(181,241,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(128,242,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(190,243,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(191,243,1);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(192,243,1);
...
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(102,230,2);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(103,231,2);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(116,233,2);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(182,234,2);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(102,237,2);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(103,238,2);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(116,240,2);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(182,241,2);
...
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(106,231,3);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(117,233,3);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(185,234,3);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(106,238,3);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(117,240,3);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(185,241,3);
...
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(105,231,4);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(119,233,4);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(105,238,4);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(119,240,4);
...
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(107,231,5);
INSERT INTO fields_controller(id_field,id_group,ord)	VALUES(107,238,5);
...
INSERT INTO object_types(id,id_parent,id_element_type,is_locked,is_guidable,is_public,title)	VALUES(58,NULL,NULL,0,1,1,'Список адресов');
INSERT INTO object_types(id,id_parent,id_element_type,is_locked,is_guidable,is_public,title)	VALUES(63,11,28,0,0,1,'форма 1');
INSERT INTO object_types(id,id_parent,id_element_type,is_locked,is_guidable,is_public,title)	VALUES(64,11,28,0,0,1,'Форма жалобы');
...
INSERT INTO objects(id,id_type,is_locked,title)	VALUES(10201,58,0,'gmail');
INSERT INTO objects(id,id_type,is_locked,title)	VALUES(10202,63,0,'Новая страница');
INSERT INTO objects(id,id_type,is_locked,title)	VALUES(10203,58,0,'фабрика');
INSERT INTO objects(id,id_type,is_locked,title)	VALUES(10204,58,0,'all');
INSERT INTO objects(id,id_type,is_locked,title)	VALUES(10205,63,0,'Новая страница 1');
INSERT INTO objects(id,id_type,is_locked,title)	VALUES(10206,58,0,'Prime');
INSERT INTO objects(id,id_type,is_locked,title)	VALUES(10207,64,0,'ФОС');
...
ADD CONSTRAINT `fk_element_parent` FOREIGN KEY (`id_parent`) REFERENCES `elements` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION;
