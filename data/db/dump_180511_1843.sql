...
CREATE TABLE `elements` (
  ...
  KEY `fk_element_menu` (`id_menu`)) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `field_groups` (
  ...
  KEY `fk_field_groups_object_types` (`id_obj_type`)) ENGINE=InnoDB AUTO_INCREMENT=227 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `fields` (
  ...
  KEY `fk_fields_field_types` (`id_type`)) ENGINE=InnoDB AUTO_INCREMENT=181 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `object_types` (
  ...
  KEY `fk_object_type_parent` (`id_parent`)) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `objects` (
  ...
  KEY `name` (`title`),
  KEY `is_locked` (`is_locked`)) ENGINE=InnoDB AUTO_INCREMENT=10196 DEFAULT CHARSET=cp1251;
