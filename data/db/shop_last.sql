...
CREATE TABLE `elements` (
  ...
  KEY `fk_element_menu` (`id_menu`)) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `field_groups` (
  ...
  KEY `fk_field_groups_object_types` (`id_obj_type`)) ENGINE=InnoDB AUTO_INCREMENT=211 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `fields` (
  ...
  KEY `fk_fields_field_types` (`id_type`)) ENGINE=InnoDB AUTO_INCREMENT=162 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `object_types` (
  ...
  KEY `fk_object_type_parent` (`id_parent`)) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `objects` (
  ...
  KEY `name` (`title`),
  KEY `is_locked` (`is_locked`)) ENGINE=InnoDB AUTO_INCREMENT=10101 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `users` (
  ...
  KEY `fk_users_usergroup` (`id_usergroup`)) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=cp1251;
...
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(5,149,NULL,NULL,'kifirch@mail.ru',NULL,NULL,NULL);
...
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10041,102,NULL,NULL,NULL,'<p>текст до регистрации</p>',NULL,NULL);
...
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10055,152,NULL,NULL,'1296202818jl.jpeg',NULL,NULL,NULL);
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10055,153,NULL,NULL,NULL,'<p>Описание товара такое описание</p>',NULL,NULL);
...
INSERT INTO content(id_obj,id_field,val_int,val_float,val_varchar,val_text,val_rel_obj,val_rel_elem)	VALUES(10058,102,NULL,NULL,NULL,'<p>123</p>',NULL,NULL);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(1,NULL,17,10000,1,0,1000,1,0,1,'Главная','2010-11-16 17:06:11',1);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(5,NULL,28,10004,1,0,1000,1,0,0,'Контакты','2010-11-16 16:49:48',5);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(14,22,37,10013,1,NULL,10016,1,0,0,1288265827,'2010-10-28 17:17:35',1);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(16,NULL,39,10015,1,NULL,NULL,1,0,0,'найдено_в_каталоге',NULL,NULL);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(17,NULL,41,10017,1,NULL,1000,0,0,0,1288272041,'2010-11-08 13:24:49',8);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(22,NULL,37,10022,1,NULL,10016,1,0,0,1288272919,'2010-11-10 13:20:07',9);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(23,NULL,24,10026,1,NULL,NULL,1,0,0,'sitemap','2010-11-08 16:55:16',NULL);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(28,NULL,44,10033,1,NULL,1000,1,0,0,'Новости','2010-12-02 11:00:01',10);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(29,NULL,17,10034,1,NULL,1000,1,0,0,1290067882,'2010-11-18 11:33:01',11);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(33,NULL,48,10043,1,NULL,NULL,1,0,0,1291387335,'2010-12-03 17:42:16',12);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(34,NULL,47,10041,1,NULL,1000,1,0,0,'Регистрация','2010-12-15 17:26:35',NULL);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(39,NULL,52,10054,1,NULL,1000,1,0,0,'Муагазин','2011-01-13 16:06:36',13);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(40,39,51,10055,1,NULL,NULL,1,0,0,'Монитор','2011-01-28 11:20:26',1);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(41,39,51,10056,1,NULL,NULL,1,0,0,1294924171,'2011-01-13 16:09:56',2);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(42,39,51,10057,1,NULL,NULL,1,0,0,1294927350,'2011-01-13 17:03:07',3);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(43,NULL,54,10058,1,NULL,NULL,1,0,0,'shopcart','2011-01-17 14:44:40',NULL);
...
INSERT INTO objects(id,id_type,is_locked,title)	VALUES(10054,30,0,'Категория 87');
INSERT INTO objects(id,id_type,is_locked,title)	VALUES(10055,29,0,'Монитор');
INSERT INTO objects(id,id_type,is_locked,title)	VALUES(10056,29,0,'Товаренок 2');
...
INSERT INTO users(id,name,id_object,id_usergroup,is_active,password)	VALUES(9,'admin',10025,4,1,'53fe02eb1156d02e7828e32b12d6679a');
