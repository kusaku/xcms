...
CREATE TABLE `elements` (
  ...
  KEY `fk_element_menu` (`id_menu`)) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `field_groups` (
  ...
  KEY `fk_field_groups_object_types` (`id_obj_type`)) ENGINE=InnoDB AUTO_INCREMENT=212 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `fields` (
  ...
  KEY `fk_fields_field_types` (`id_type`)) ENGINE=InnoDB AUTO_INCREMENT=165 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `object_types` (
  ...
  KEY `fk_object_type_parent` (`id_parent`)) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `objects` (
  ...
  KEY `name` (`title`),
  KEY `is_locked` (`is_locked`)) ENGINE=InnoDB AUTO_INCREMENT=10106 DEFAULT CHARSET=cp1251;
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(1,NULL,17,10000,1,0,1000,1,0,1,'Главная','2011-05-10 18:49:26',2);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(14,NULL,37,10013,1,NULL,10016,1,0,0,1288265827,'2010-10-28 17:17:35',3);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(28,28,44,10033,1,NULL,1000,1,0,0,'Новости','2010-12-02 11:00:01',6);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(34,NULL,47,10041,1,NULL,1000,1,0,0,'Регистрация','2010-12-15 17:26:35',1);
...
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(39,NULL,52,10054,1,NULL,1000,1,0,0,'Муагазин','2011-01-13 16:06:36',1);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(40,39,51,10055,1,NULL,NULL,1,0,0,'Монитор','2011-01-28 11:20:26',2);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(41,39,51,10056,1,NULL,NULL,1,0,0,1294924171,'2011-01-13 16:09:56',3);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(42,39,51,10057,1,NULL,NULL,1,0,0,1294927350,'2011-01-13 17:03:07',1);
INSERT INTO elements(id,id_parent,id_type,id_obj,id_lang,id_tpl,id_menu,is_active,is_deleted,is_default,urlname,updatetime,ord)	VALUES(43,NULL,54,10058,1,NULL,NULL,1,0,0,'shopcart','2011-01-17 14:44:40',1);
...
INSERT INTO object_types(id,id_parent,id_element_type,is_locked,is_guidable,is_public,title)	VALUES(38,NULL,NULL,0,0,1,'Сотрудники');
