 ...
 * @category   Xcms
 * @package    Language
 * @version    $Id: ru.php 545 2010-10-29 11:16:34Z igor $
 */
return array(
    ...
    "'%value%' was not found in the haystack" => "'%value%' не найдено в перечисленных допустимых значениях",
	 ...
	 // Zend_Validate_FileNotExists
    "File '%value%' already exists" => "Файл '%value%' уже существует",
    ...
    "Invalid type given, value should be a string" => "Недопустимый тип данных, значение должно быть строкой",
    "'%value%' is less than %min% characters long" => "'%value%' короче %min% символов",
    "'%value%' is more than %max% characters long" => "'%value%' длинней %max% символов",

	"A record with the supplied identity could not be found." => "Неправильный логин.",
	"Supplied credential is invalid." => "Неправильный пароль.",
	
	"Captcha value is wrong" => "Неверно введен код",
	
	"Email is not valid" => "Проверьте корректность написания email"
);