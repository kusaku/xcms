...
/**
 * 
 * Свойство - шаблон (виртуальное)
 * 
 * @category   Xcms
 * @package    Model
 * @subpackage Model_Entity_Property
 * @version    $Id: Template.php 238 2010-07-02 11:43:40Z renat $
 */

class Model_Entity_Property_Template extends Model_Entity_Property_Select {
	
	/**
	 * Устанавливает значение свойства
	 * @param int $value
	 * @param Model_Entity_Element $element объект элемента данного свойства
	 * @return Model_Entity_Property_Template $this
	 */
	...
	protected function getOptions() {
		...
		$mct = Model_Collection_Templates::getInstance();
